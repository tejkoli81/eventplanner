...
<body>
	<?php if (isset($_POST['save'])) {
     ...
     if (mysqli_num_rows($rs) > 0) { ?>
		<script>
			swal({title: "Planner Register", text: "Planner already registered", type: "error"}, function(){location.href='add_planner.php'});
		</script>			
	<?php } else {
         ...
         mysqli_query(
             $con,
             "insert into planner(planner_name, planner_address, planner_phone, planner_email, planner_pic) values ('$name','$addr','$phone','$email','$path')"
         );
         ?>
		<script>
			swal({title: "Planner Register", text: "Planner registered successfully", type: "success"}, function(){location.href='manage_planners.php'});
		</script>			
	<?php }
 } ?>
