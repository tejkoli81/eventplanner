...
if ($page > $number_of_pages) {
    header('Location: view_planners.php?page=' . $number_of_pages);
}
?>
...
<body>
								...
								<div class="row">
									<div class="col-md-4 mt-2 mb-4 ml-auto">
										<div class="input-group">
						                	<input type="text" name="search" id="search" onkeyup="SearchField();" class="form-control shadow-none" placeholder="Search Planner">
									...
									<nav aria-label="Page navigation example" style="background-color: transparent;">
		                              <ul class="pagination justify-content-end">
		                                ...
		                                <?php if ($page > 1) { ?>  
		                                  ...
		                                  <li class="page-item"><a href="<?php echo 'view_planners.php?page=' .
                                        ...
                                        echo '<li class="page-item"><a href="view_planners.php?page=' .
                                            $page .
                                            '" class="page-link">' .
                                            $page .
                                            ' ' .
	...
	<script type="text/javascript">
		function SearchField() {
			...
			xmlhttp.open("GET", "cust_planner_search.php?search="+document.getElementById('search').value, false);
			xmlhttp.send(null);
