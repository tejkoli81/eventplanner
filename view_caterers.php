...
$result1 = mysqli_query($con, "SELECT * FROM vendor where v_type='Caterer'");
...
$result = mysqli_query(
    $con,
    "SELECT * FROM vendor where v_type='Caterer' ORDER BY v_id LIMIT $this_page_first_result, $results_per_page"
);
$count = mysqli_num_rows($result);

if ($page > $number_of_pages) {
    header('Location: view_caterers.php?page=' . $number_of_pages);
}
?>
...
<body>
								...
								<div class="row">
									<div class="col-md-4 mt-2 mb-4 ml-auto">
										<div class="input-group">
						                	<input type="text" name="search" id="search" onkeyup="SearchField();" class="form-control shadow-none" placeholder="Search Caterers">
									...
									<nav aria-label="Page navigation example" style="background-color: transparent;">
		                              <ul class="pagination justify-content-end">
		                                ...
		                                <?php if ($page > 1) { ?>  
		                                  ...
		                                  <li class="page-item"><a href="<?php echo 'view_caterers.php?page=' .
                                        ...
                                        echo '<li class="page-item"><a href="view_caterers.php?page=' .
                                            $page .
                                            '" class="page-link">' .
                                            $page .
                                            ' ' .
	...
	<script type="text/javascript">
		function SearchField() {
			...
			xmlhttp.open("GET", "caterer_search.php?search="+document.getElementById('search').value, false);
			xmlhttp.send(null);
