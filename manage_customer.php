...
$result = mysqli_query(
    $con,
    "SELECT * FROM customer ORDER BY cust_id LIMIT $this_page_first_result, $results_per_page"
);
$count = mysqli_num_rows($result);

if ($page > $number_of_pages) {
    header('Location: manage_customer.php?page=' . $number_of_pages);
}
?>
...
<script type="text/javascript">
	function del(id){
		...
		function(){
		  location.href="delete_customer.php?id="+id;
		});	
	}
	</script>
						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								<div class="top-part mb-3">
									...
									<p class="d-inline ml-2">Customers</p>
									...
									<nav aria-label="Page navigation example" style="background-color: transparent;">
		                              <ul class="pagination justify-content-end">
		                                ...
		                                <?php if ($page > 1) { ?>  
		                                  ...
		                                  <li class="page-item"><a href="<?php echo 'manage_customer.php?page=' .
                                        ...
                                        echo '<li class="page-item"><a href="manage_customer.php?page=' .
                                            $page .
                                            '" class="page-link">' .
                                            $page .
                                            ' ' .
	...
	<script type="text/javascript">
		function SearchField() {
			...
			xmlhttp.open("GET", "customer_search.php?search="+document.getElementById('search').value, false);
			xmlhttp.send(null);
