...
if (isset($_POST['update'])) {
    ...
    if (mysqli_num_rows($rs) > 0) { ?>
       <script>
           swal({title: "Planner Profile", text: "Planner already registered", type: "error"}, function(){location.href='planner-profile.php'});
       </script>			
   <?php } else {
        ...
        ?>
       <script>
           swal({title: "Planner Profile", text: "Planner updated successfully", type: "success"}, function(){location.href='planner-profile.php'});
       </script>			
   <?php }
}
...
$rs = mysqli_query(
    $con,
    'select * from planner where planner_id=' . $_SESSION['pid']
);
			...
			<div class="container-fluid">
				<div class="row">
                  ...
                  'planner_id'
									  	...
									  	<div class="form-group">
									    	<label for="name" style="font-weight: 600;">Planner Name</label>
									    	<input type="text" name="name" class="form-control shadow-none" id="name" placeholder="Enter Planner Name" value="<?= $row[
                  'planner_name'
              ] ?>" required>
									  	</div>
									  	<div class="form-group">
