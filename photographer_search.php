...
$result = mysqli_query(
    $con,
    "SELECT * FROM vendor WHERE (v_id like ('%$search%') OR v_name like ('%$search%') OR v_contact_person like ('%$search%') OR v_address like ('%$search%') OR v_phone like ('%$search%') OR v_email like ('%$search%') OR v_description like ('%$search%') OR v_website like ('%$search%')) AND v_type='Photographer' ORDER BY v_id"
);
