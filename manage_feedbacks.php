...
$result = mysqli_query(
    $con,
    "SELECT * FROM feedback ORDER BY f_id LIMIT $this_page_first_result, $results_per_page"
);
$count = mysqli_num_rows($result);

if ($page > $number_of_pages) {
    header('Location: manage_feedbacks.php?page=' . $number_of_pages);
}
?>
...
<script type="text/javascript">
	function del(id){
		...
		function(){
		  location.href="delete_feedback.php?id="+id;
		});	
	}
	</script>
				...
				<div class="row">
						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								<div class="top-part mb-3">
									...
									<p class="d-inline ml-2">Feedbacks</p>
                  ...
                  while ($data = mysqli_fetch_assoc($result)) { ?>	
				  							<tr>		
												      		...
												      		<td><?php echo $data['f_by']; ?></td>
												      		<td><?php echo $data['f_msg']; ?></td>
												      		<td>
												      			<div class="row">
												      				<a onclick="del(<?= $data[
                          'f_id'
									...
									<nav aria-label="Page navigation example" style="background-color: transparent;">
		                              <ul class="pagination justify-content-end">
		                                ...
		                                <?php if ($page > 1) { ?>  
		                                  ...
		                                  <li class="page-item"><a href="<?php echo 'manage_feedbacks.php?page=' .
                                        ...
                                        echo '<li class="page-item"><a href="manage_feedbacks.php?page=' .
                                            $page .
                                            '" class="page-link">' .
                                            $page .
                                            ' ' .
