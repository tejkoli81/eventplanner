...
$result1 = mysqli_query($con, 'SELECT * FROM planner');
...
$result = mysqli_query(
    $con,
    "SELECT * FROM planner ORDER BY planner_id LIMIT $this_page_first_result, $results_per_page"
);
$count = mysqli_num_rows($result);

if ($page > $number_of_pages) {
    header('Location: manage_planners.php?page=' . $number_of_pages);
}
?>
...
<script type="text/javascript">
	function del(id){
		...
		function(){
		  location.href="delete_planner.php?id="+id;
		});	
	}
</script>
				...
				<div class="row">
						...
						<div class="below-toggle-content">
							<div class="col-md-12">
								<div class="top-part mb-3">
									...
									<p class="d-inline ml-2">Planners</p>
								...
								<div class="row">
									<div class="col-md-4">
										<a href="add_planner.php" class="btn btn-primary ml-1">Add Planner</a>
									</div>
				  ...
				  <tr>		
                     ...
                     'planner_pic'
												      		...
												      		<td><?php echo $data['planner_id']; ?></td>	
												      		...
												      		<td>
												      			<div class="row">
												      				<a href="update_planner.php?id=<?php echo $data[
                          'planner_id'
									...
									<nav aria-label="Page navigation example" style="background-color: transparent;">
		                              <ul class="pagination justify-content-end">
		                                ...
		                                <?php if ($page > 1) { ?>  
		                                  ...
		                                  <li class="page-item"><a href="<?php echo 'manage_planners.php?page=' .
                                        ...
                                        echo '<li class="page-item"><a href="manage_planners.php?page=' .
                                            $page .
                                            '" class="page-link">' .
                                            $page .
                                            ' ' .
	...
	<script type="text/javascript">
		function SearchField() {
			...
			xmlhttp.open("GET", "planner_search.php?search="+document.getElementById('search').value, false);
			xmlhttp.send(null);
